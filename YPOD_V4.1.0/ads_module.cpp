...
ADS_Module::ADS_Module()
{
  ...
  ads_module[CO_CH1].addr = 0x49;
  ads_module[CO_CH1].channel = 0;

  ads_module[CO_CH2].addr = 0x49;
  ads_module[CO_CH2].channel = 1;
...
ads_noheaters ADS_Module::return_updated()
{
  ...
  delay(100);
  ads_user.CO_ch1 = read_raw(CO_CH1);
  delay(100);
  ads_user.CO_ch2 = read_raw(CO_CH2);
  delay(100);
