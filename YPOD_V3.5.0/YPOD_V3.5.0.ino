    ...
    if(file.isOpen())
    {
      ...
      delay(100);
        ...
        // Temeprature
          ...
          float tempt = cal.calibrate(ads_data.CO, CO2, humidity_SHT25, temperature_SHT25).T_; // Temp variable to store object
          file.print(tempt);
        #else
        ...
        // Relative humidity
          ...
          float temprh = cal.calibrate(ads_data.CO, CO2, humidity_SHT25, temperature_SHT25).RH_; // Temp varibale to store object
          file.print(temprh);
        #else
      ...
      // CO
        ...
        int tempco = cal.calibrate(ads_data.CO, CO2, humidity_SHT25, temperature_SHT25).CO_; // Temp variable to store object
        file.print(tempco); 
      #else
      ...
      // CO2
        ...
        int tempco2 = cal.calibrate(ads_data.CO, CO2, humidity_SHT25, temperature_SHT25).CO2_; // Temp variable to store object
        file.print(tempco2);
      #else
